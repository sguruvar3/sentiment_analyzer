 ...
 */
public class NegativeWords extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		dir += "Rulebase";
		ArrayList<String> goodWords = readAsArrayList(dir+"/ruleset_bad.txt");
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/NegativeWords.jsp");
